# -*- coding: UTF-8 -*-
"""
:filename: sppas.src.annotations.CuedSpeech.wherecue.wherecueexc.py
:author:   Brigitte Bigi
:contact:  contact@sppas.org
:summary:  Exceptions for the Cued Speech position predictor.
...
class sppasWhereCuedSightsValueError(ValueError):
    """:ERROR 1332:.
    ...
    def __init__(self, value, frame):
        ...
        self.parameter = error(self._status) + \
                         (error(self._status, "annotations")).format(value, frame)
