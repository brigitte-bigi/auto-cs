"""
:filename: sppas.ui.swapp.app_cues_utils.nodes.yoyo_message.py
...
MSG_YOYO_SORRY = msg("An error occurred", "textcues")
...
class BaseYoyoMessageNode(HTMLNode):
    ...
    def append_image(self, yoyo_image: str) -> EmptyNode:
        ...
        _img = EmptyNode(
            ...
            attributes={
                "alt": "YOYO",
                "src": wapp_settings.images + YOYO_IMAGES_PATH + "/" + yoyo_image
            }
        )
