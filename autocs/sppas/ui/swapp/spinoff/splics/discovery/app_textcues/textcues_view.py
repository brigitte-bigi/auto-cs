"""
:filename: sppas.ui.swapp.spinoff.splics.discovery.app_textcues.textcues_view.py
...
BODY_SCRIPT = f"""
        import {{ TextCueSManager }} from '/{splics_paths.js}textcues_manager.js';
...
class TextCueSView(swappBaseView):
    ...
    def populate_head(self) -> None:
        ...
        script.add_attribute("src", splics_paths.js + "textcues_manager.js")
