"""
:filename: sppas.ui.swapp.spinoff.splics.discovery.app_textcues.views.pathway_code_view.py
...
HTML_REFERENCE = """
    ...
    <blockquote>
        <p>
            Brigitte Bigi (2025).
            <a class="external-link" href="https://aclanthology.org/2025.icnlsp-1.2/">Bridging the Gap: Design and Evaluation of an Automated System for French Cued Speech</a>
            Association for Computational Linguistics, Proceedings of the 8th International Conference on Natural Language and Speech Processing (ICNLSP-2025),
            pages 8-18, Odense, Denmark.
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            Brigitte Bigi (2023).
            <a class="external-link" href="https://hal.science/hal-04081282">An analysis of produced versus predicted French Cued Speech keys.</a>
            In 10th Language & Technology Conference: Human Language Technologies as a Challenge for Computer Science and Linguistics, 
