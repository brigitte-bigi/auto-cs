"""
:filename: sppas.ui.swapp.spinoff.splics.discovery.app_twincues.twincues_record.py
...
class TwinCueSRecord:
    ...
    def __init__(self):
        ...
        # Any extra data: cues_result, words_result, error, content, ...
        self.__extras = dict()
    ...
    def serialize(self) -> dict:
        ...
        if self.__word is not None and len(self.__word) > 0:
            d["word"] = self.__word
    ...
    def get_word(self) -> str:
        """Return the stored input word."""
        return self.__word

    def set_word(self, value: str) -> None:
        """Set the stored word after validating it.
