"""
:filename: sppas.ui.swapp.spinoff.splics.nodes.cues.key_piano.py
...
MSG_PIANO_SHAPE_GROUP = msg("Shape", "splics")
MSG_PIANO_POSITION_GROUP = msg("Position", "splics")
MSG_KEY_CODE = msg("Code", "splics")
MSG_KEY_PHONES = msg("Phonemes", "splics")
