"""
:filename: sppas.ui.swapp.spinoff.splics.nodes.cues.illustration.py
...
class CuedIllustration:
    ...
    def yoyo_hand_image(parent, img_path: str) -> EmptyNode:
        ...
        if os.path.exists(img_path):
            ...
            dest = os.path.join(splics_paths.images + "textcues/yoyo_0_bw.png")
    ...
    def yoyo_face_image(parent, img_path: str) -> EmptyNode:
        ...
        if os.path.exists(img_path):
            ...
            dest = os.path.join(splics_paths.images + "textcues/yoyo_bw.jpg")
            _img.add_attribute("src", dest)
