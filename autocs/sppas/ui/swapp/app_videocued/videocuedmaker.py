...
from ..htmltags.hstatusnode import HTMLStatusNode
from ..htmltags import SwapHeader
from ..htmltags import SwapFooter
...
class VideoCuedResponseRecipe(WhakerKitResponse):
    ...
    def create(self):
        ...
        self._htree.body_header = SwapHeader(self._htree.identifier, title="CuedSpeech Video Tagger")
    ...
    def _bake(self) -> None:
        if self._status.code == 410:
            self._htree.body_main.append_child(
                HTMLStatusNode(self._htree.body_main.identifier, None, self._status.code, "Time to say Goodbye!"))
            return None
