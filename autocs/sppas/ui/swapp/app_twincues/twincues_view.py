"""
:filename: sppas.ui.swapp.app_twincues.twincues_view.py
...
BODY_SCRIPT = f"""
        import {{ TwinCueSManager }} from '/{wapp_settings.js}twincues_manager.js';
...
class TwinCueSView(swappBaseView):
    ...
    def populate_head(self) -> None:
        ...
        # CSS
        # ----
        self._htree.head.link(rel="logo icon", href=wapp_settings.icons + "Refine/twincues.png")
        ...
        script.add_attribute("src", wapp_settings.js + "twincues_manager.js")
    ...
    def populate_body_header(self, title, *args, **kwargs):
        ...
        logo.set_attribute("src", wapp_settings.icons + "Refine/twincues.png")
