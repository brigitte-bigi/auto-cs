"""
:filename: sppas.ui.swapp.app_twincues.app_twincues.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: Bakery for the web-based application "TwinCueS".
...
class TwinCueSWebData(swappWebData):
    ...
    def icon() -> str:
        ...
        return sppasImagesAccess.get_icon_filename("twincues")
