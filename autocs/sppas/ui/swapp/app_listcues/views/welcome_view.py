"""
:filename: sppas.ui.swapp.app_listcues.views.welcome_view.py
:author: Brigitte Bigi
:contact: contact@sppas.org
:summary: View of the "ListCueS" welcome page.
...
from ..listcues_msg import MSG_INTRO
...
class ListCueSWelcomeView:
    ...
    def __init__(self, parent: HTMLNode, record: ListCueSRecord):
        ...
        needed to build the key piano, and the application is stateless,
        so it must travel with the navigation to the conversion content
        ...
        """
        # section 1: intro + yoyo welcome message
        # -----------------------------------------
        ...
        _yoyo = YoyoMessageNode(_part_1.identifier, MSG_YOYO_WELCOME)
        _yoyo.add_attribute("class", "width_20")
